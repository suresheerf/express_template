...
const { JWT_EXPIRES_IN, JWT_COOKIE_EXPIRES_IN, JWT_SECRET } = require('../config/config');
...
module.exports.signUp = catchAsync(async (req, res, next) => {
  ...
  if (isEmailAlreadyTaken) return next(new AppError('Email has been registered', 400));
